...
export default function CancellationRefundPage() {
  return (
    <div className="mb-10 flex grow justify-center px-3 pt-8 sm:pt-10">
      <Card className="mx-2 w-full max-w-4xl border-gray-200 p-6 shadow-md sm:p-10">
        <CardContent className="flex flex-col items-start gap-y-8 p-0 text-gray-700">
          ...
          <section>
            ...
            <ul className="mb-2 list-inside list-disc">
              ...
              <li>
                ...
                Once your order has been shipped, cancellations are not
                permitted.
              </li>
              <li>
                <span className="font-medium">How to Cancel:</span> Submit a
                request via email or our customer service contact method with
                your order number and reason for cancellation.
              </li>
              <li>
                <span className="font-medium">Right to Refuse:</span> We may
                refuse cancellation requests made after the 24-hour window or
                once shipping has begun.
              </li>
            </ul>
            <p className="text-sm text-gray-600">
              Note: Because prints are personalized products, we begin
              processing soon after purchase.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              <span className="font-medium">genuine reasons</span> as
              determined solely by us. Eligible cases typically include:
            </p>
            <ul className="mb-2 list-inside list-disc">
            ...
            <p className="mb-2">
              <span className="font-medium">Non-eligible cases</span> include
              (but are not limited to):
            </p>
            <ul className="mb-2 list-inside list-disc">
              <li>
                Customer dissatisfaction with photo quality, color, or
                personal appearance
              </li>
              <li>Color variance between screens and prints</li>
              <li>
                Content issues with user-submitted photos (cropping,
          ...
          <section>
            ...
            <ol className="mb-2 list-inside list-decimal">
              <li>
                Prepare your order number and a brief description of the
                issue.
              </li>
              <li>
                Contact us via email or our support channel (see Contact
                section below) within the applicable window.
              </li>
              <li>
                For damaged/defective items, include clear photos of the
                product and packaging.
              </li>
            </ol>
            <p className="text-sm text-gray-600">
              We may request additional information to verify and resolve
              your claim.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-inside list-disc">
              <li>
                <span className="font-medium">Cancellation:</span> Within 24
                hours of purchase and prior to shipping.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mb-2">
              For eligible issues (e.g., defective prints, incorrect items),
              we may offer a{" "}
            ...
            <ul className="list-inside list-disc">
              <li>
                If replacement is approved, we&apos;ll reproduce and ship the
                corrected items at no extra cost.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-inside list-disc">
              <li>
                ...
                responsible for delays caused by carriers. Refunds are not
                issued for carrier delays.
              </li>
              <li>
                <span className="font-medium">Risk of Loss:</span> Passes to
                you upon delivery to the shipping address provided.
              </li>
              <li>
                <span className="font-medium">Non-Delivery:</span> If
                tracking shows undelivered, contact us within 30 days so we
                can investigate with the carrier.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Our prints are personalized and made to order. Minor variations
              in trimming, alignment, and color reproduction can occur and are
          ...
          <section>
            ...
            <p>
              Our liability is limited to the amount paid for your order. We
          ...
          <section>
            ...
            <p>
              ...
              time. Changes take effect upon posting on this page.
            </p>
          </section>
        </CardContent>
      </Card>
