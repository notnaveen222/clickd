      ...
      <Card className="mx-2 w-full max-w-4xl border-gray-200 p-6 shadow-md sm:p-10">
        <CardContent className="flex flex-col items-start gap-y-8 p-0 text-gray-700">
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800">Photo Data</h3>
            <ul className="mb-2 list-inside list-disc">
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800">Primary Uses</h3>
            <ul className="mb-2 list-inside list-disc">
            ...
            <h3 className="font-medium text-gray-800">Secondary Uses</h3>
            <ul className="list-inside list-disc">
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800">Automatic Deletion</h3>
            <p className="mb-2">
              All photos are automatically deleted from our servers within 3
              days of order completion. This includes original photos and any
              processed versions. Photos are permanently removed with no
              recovery possible.
            </p>
            <h3 className="font-medium text-gray-800">Processing Period</h3>
            <p>
              Photos are temporarily stored only for the time needed to
              process and fulfill your order. During this period, photos are
              stored securely with encryption. Access is limited to authorized
              personnel involved in order fulfillment.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800">Non-Photo Data</h3>
            <p className="mb-2">
              Order information, contact details, and transaction records are
              retained for business and legal purposes. This data is kept for
              up to 7 years for accounting, tax, and legal compliance. Payment
              information is handled by our payment processors and not stored
              on our servers.
            </p>
            ...
            <p>
              ...
              ensure service security. This includes order history,
              communication records, and account information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              with legal processes or government requests, protect our rights
              and property, prevent fraud or security threats, and protect
              user safety.
            </p>
            <h3 className="font-medium text-gray-800">No Sale of Personal Data</h3>
            <p>
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800">Access and Control</h3>
            <ul className="mb-2 list-inside list-disc">
          ...
          <section>
            ...
            <p>
              ...
              experience. Analytics cookies help us understand how our
